...
void addEntry()
{
    ...
    printf("\nEnter today's work(1.Clean clothes...):\n ");
    printf("----------------------------------\n\n");
    getchar();
    ...
    printf("\nEnter name of places that need to visit(e.g.,1.Hospital(10:30 pM)): \n");
    printf("---------------------------------------------------------------------\n\n");
    ...
    printf("For mark this page ,Enter 1 else 0 : ");
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("4. Display only Bookmark pages.\n");
        printf("5. Exit\n\n");
